...
def create_accel_command(packer, accel, pcm_cancel, standstill_req, lead, acc_type, long_press, distance):
...
def create_ui_command(packer, steer, chime, left_line, right_line, left_lane_depart, right_lane_depart, faded_line, enabled):
  values = {
